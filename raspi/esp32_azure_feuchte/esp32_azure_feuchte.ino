...
static const char* connectionString = "HostName=derFruchtigeHubber.azure-devices.net;DeviceId=derHubberPy2;SharedAccessKey=QVqTTpIMrSV4Vhfio0pmDgnyKTSqDG/G4Oc2bkmfs30=";
...
void loop()
{
  if (hasWifi)
  {
        ...
        (int)(millis() - send_interval_ms) >= INTERVAL)
    {
      ...
      if(sensorValue < 2048)
        humidity = (float)100.0;
      else
        humidity = (float)((sensorValue - 2047) *100 / 2048)*(-1) +100;
